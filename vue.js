...
const App = {
  ...
  computed: {
    ...
    textCurrentStep() {
      let currentIndex = this.activeIndex >= this.steps.length ? this.steps.length-1: this.activeIndex;
      return this.steps[currentIndex].text;
    },
    ...
    textBtnNextOfFinish() {
      let captionBtn = this.activeIndex >= this.steps.length -1 ? 'Закончить' : 'Дальше';
          return captionBtn;
    }
  }
}
